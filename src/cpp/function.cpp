...
void Function::_destroy() { DES_CHECK;
	m_function = nullptr;
	_isDestroyed = true;
}


JS_IMPLEMENT_METHOD(Function, destroy) { THIS_CHECK;
	_destroy();
	RET_UNDEFINED;
}


JS_IMPLEMENT_GETTER(Function, isDestroyed) { THIS_CHECK;
	RET_BOOL(_isDestroyed);
}

#include <iostream>
JS_IMPLEMENT_METHOD(Function, launchKernel) { THIS_CHECK;
